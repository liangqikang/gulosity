...
WeixinJSBridge.call('hideToolbar');
    ...
    <body>
        <div id="container">
            ...
            <div id="payrow">
                <div class="pay" onclick="vippay"><font style="font-size: 20px;letter-spacing:8px">会员支付</font><br>(余额：0 RMB)</div>
                <div class="recharge" onclick="recharge">充值</div>
                <div style="clear:both"></div>
            </div>
            <div id="center" onclick="vipcenter">我的会员中心</div>
        </div>
